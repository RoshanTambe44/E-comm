...
export default function Adminpage({uid, uname}) {
  ...
  return (
    <div className="admin-main">
      <div className="admin-navbar">
        <div className="admin-nav-left">admin panel ({uname})</div>
        <div className="admin-nav-right" onClick={()=>navigator("/")}>X</div>
      </div>
              ...
              <tbody style={{ cursor: "pointer" }}>
                {users.map((user, index) => (
                  <tr key={index}>
                    ...
                    {user.roll !== "superadmin" || uid === user.id ? <td className="text-center">
